...
public class PopulateDB {
    ...
    public void GenerateService(Connection conn) throws Exception{

        String ServicesInsert = "Insert into Services(ServiceID, ServiceName, ServiceDuration, ServicePrice, ServiceMaterials)" +
                "VALUES (?, ?, ?, ?, ?)";

        try (PreparedStatement query = conn.prepareStatement(ServicesInsert)){
            query.setInt(1, service.getServiceID());
